/**
 * @module Clients / Symbols
 * @category Entities
 */
import { AxiosResponse } from 'axios';
import { JwtConfig, LedgerIdentifier, LedgerPagedList, LedgerRecord, LedgerSymbol } from "../../../types/src";
...
export declare class SymbolsResponse extends BaseListResponse<LedgerSymbol> {
    ...
    constructor(response: AxiosResponse<LedgerPagedList<LedgerSymbol>, void>);
}
/**
...
export declare class SymbolClient extends BaseClient {
     ...
     *
     */
    change: BaseChangeClient<LedgerSymbol>;
     ...
     */
    init(record?: Partial<LedgerRecord<LedgerSymbol>>): CreateRecordBuilder<LedgerSymbol, SymbolResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     ...
     * @returns a builder instance
     */
    edit(record: LedgerRecord<LedgerSymbol>): UpdateRecordBuilder<LedgerSymbol, SymbolResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     * Initializes a builder instance for updating existing records.
     * The builder supports chaining to make it easier to work with
     ...
     * @returns a builder instance
     */
    from(record: LedgerRecord<LedgerSymbol>): UpdateRecordBuilder<LedgerSymbol, SymbolResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     ...
     */
    read(id: LedgerIdentifier, authParams?: Partial<JwtConfig>): Promise<SymbolResponse>;
    /**
