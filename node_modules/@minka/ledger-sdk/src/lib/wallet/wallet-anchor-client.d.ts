...
export declare class WalletAnchorClient extends BaseClient {
     ...
     */
    lookup(record?: Partial<LedgerRecord<Partial<LedgerAnchor>>>): LookupRecordBuilder<Partial<LedgerAnchor>, WalletAnchorsLookupResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
}
