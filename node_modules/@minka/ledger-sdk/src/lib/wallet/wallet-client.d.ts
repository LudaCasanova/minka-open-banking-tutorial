...
import { JwtConfig, LedgerAddress, LedgerBalance, LedgerIdentifier, LedgerLimit, LedgerLuid, LedgerPagedList, LedgerRecord, LedgerWallet } from "../../../types/src";
...
export declare class WalletClient extends BaseClient {
     ...
     */
    init(record?: Partial<LedgerRecord<LedgerWallet>>): CreateRecordBuilder<LedgerWallet, WalletResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     ...
     * @returns a builder instance
     */
    edit(record: LedgerRecord<LedgerWallet>): UpdateRecordBuilder<LedgerWallet, WalletResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     * Initializes a builder instance for updating existing records.
     * The builder supports chaining to make it easier to work with
     ...
     * @returns a builder instance
     */
    from(record: LedgerRecord<LedgerWallet>): UpdateRecordBuilder<LedgerWallet, WalletResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     * Initializes a builder instance that supports chaining to make it
     * easier to work with ledger records. You can pass the record
     * payload to this method to use as initial content, this is useful
     ...
     * @returns a builder instance
     */
    drop(id?: LedgerIdentifier): DropRecordBuilder<LedgerWallet, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     ...
     */
    read(id: WalletIdentifier, authParams?: Partial<JwtConfig>): Promise<WalletResponse>;
    /**
     ...
     */
    getBalances(id: WalletIdentifier, params?: LedgerListParams): Promise<BalancesResponse>;
    /**
     ...
     */
    getLimits(id: WalletIdentifier, params?: LedgerListParams): Promise<LimitsResponse>;
    /**
     ...
     */
    getDomains(id: WalletIdentifier, params?: LedgerListParams): Promise<DomainsResponse>;
}
export {};
