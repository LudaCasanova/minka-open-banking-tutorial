...
class WalletAnchorClient extends base_client_1.BaseClient {
     ...
     */
    lookup(record) {
        const builder = new lookup_record_builder_1.LookupRecordBuilder(async (record, authParams) => {
            return this.lookupRecord(this.buildBasePath() + '/!lookup', WalletAnchorsLookupResponse, record, authParams);
        });
