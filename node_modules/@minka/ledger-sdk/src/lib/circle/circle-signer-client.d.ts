...
import { JwtConfig, LedgerCircleSigner, LedgerIdentifier, LedgerPagedList, LedgerRecord } from "../../../types/src";
...
export declare class CircleSignerClient extends BaseClient {
     ...
     */
    init(record?: Partial<LedgerRecord<LedgerCircleSigner>>): CreateRecordBuilder<LedgerCircleSigner, CircleSignerResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     * Initializes a builder instance that supports chaining to make it
     * easier to work with ledger records. You can pass the record
     * payload to this method to use as initial content, this is useful
     ...
     * @returns a builder instance
     */
    drop(id?: LedgerIdentifier): DropRecordBuilder<LedgerCircleSigner, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     ...
     */
    read(id: LedgerIdentifier, authParams?: Partial<JwtConfig>): Promise<CircleSignerResponse>;
    /**
     ...
     */
    list(params?: LedgerListParams): Promise<CircleSignersResponse>;
}
