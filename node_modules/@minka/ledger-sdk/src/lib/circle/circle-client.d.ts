...
import { JwtConfig, LedgerCircle, LedgerIdentifier, LedgerPagedList, LedgerRecord } from "../../../types/src";
...
export declare class CircleClient extends BaseClient {
     ...
     */
    init(record?: Partial<LedgerRecord<LedgerCircle>>): CreateRecordBuilder<LedgerCircle, CircleResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     ...
     * @returns a builder instance
     */
    edit(record: LedgerRecord<LedgerCircle>): UpdateRecordBuilder<LedgerCircle, CircleResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     * Initializes a builder instance for updating existing records.
     * The builder supports chaining to make it easier to work with
     ...
     * @returns a builder instance
     */
    from(record: LedgerRecord<LedgerCircle>): UpdateRecordBuilder<LedgerCircle, CircleResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     ...
     */
    read(id: LedgerIdentifier, authParams?: Partial<JwtConfig>): Promise<CircleResponse>;
    /**
     ...
     */
    list(params?: LedgerListParams): Promise<CirclesResponse>;
}
