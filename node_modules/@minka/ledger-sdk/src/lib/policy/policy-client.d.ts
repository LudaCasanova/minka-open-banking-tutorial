...
import { JwtConfig, LedgerIdentifier, LedgerPagedList, LedgerPolicy, LedgerRecord } from "../../../types/src";
...
export declare class PolicyClient extends BaseClient {
     ...
     */
    init(record?: Partial<LedgerRecord<LedgerPolicy>>): CreateRecordBuilder<LedgerPolicy, PolicyResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     ...
     * @returns a builder instance
     */
    edit(record: LedgerRecord<LedgerPolicy>): UpdateRecordBuilder<LedgerPolicy, PolicyResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     * Initializes a builder instance for updating existing records.
     * The builder supports chaining to make it easier to work with
     ...
     * @returns a builder instance
     */
    from(record: LedgerRecord<LedgerPolicy>): UpdateRecordBuilder<LedgerPolicy, PolicyResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     ...
     */
    read(id: LedgerIdentifier, authParams?: Partial<JwtConfig>): Promise<PolicyResponse>;
    /**
