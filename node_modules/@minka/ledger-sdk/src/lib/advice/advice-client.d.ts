...
export declare class AdviceClient extends BaseClient {
     ...
     */
    call(name: AdviceName, record?: Partial<LedgerRecord<AdviceAliasResolve>>): CreateRecordBuilder<unknown, AdviceAliasResolveResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
}
