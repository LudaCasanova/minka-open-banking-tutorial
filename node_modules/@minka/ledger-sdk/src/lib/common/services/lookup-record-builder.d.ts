/**
 * @module RecordBuilder / LookupRecordBuilder
...
/**
 * A handler for records lookup on the remote API.
 */
export type LookupRecordHandler<T, R, M extends LedgerMeta = LedgerMeta> = (record: LedgerRecord<T, M>, authParams: JwtConfig) => Promise<R>;
/**
 ...
 */
export declare class LookupRecordBuilder<T, R extends BaseListResponse<T, M>, M extends LedgerMeta = LedgerMeta> extends BaseRecordBuilder<T, M> {
    /**
     * A handler for anchor lookup on the remote API.
     */
    protected lookupRecord: LookupRecordHandler<T, R, M>;
    /**
     * Creates new instance of record builder.
     *
     * @param lookupRecord function which handles lookup on ledger api
     */
    constructor(lookupRecord: LookupRecordHandler<T, R, M>);
    /**
