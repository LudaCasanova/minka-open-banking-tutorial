...
class CreateRecordBuilder extends base_record_builder_1.BaseRecordBuilder {
    ...
    async send() {
        try {
            ...
            return this.createRecord(this.record, this.authParams);
        }
        catch (error) {
    ...
    /**
     * Sets custom.status 'created' to all the signatures.
     *
    ...
    sign(params) {
        const flow = fp_1.default.flow([
            ...
            fp_1.default.set('custom.status', types_1.LedgerSignatureStatus.Created),
        ]);
