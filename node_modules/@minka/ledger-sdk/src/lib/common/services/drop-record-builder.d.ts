import { JwtConfig, LedgerMeta, LedgerRecord, LedgerSigningParams } from "../../../../types/src";
 ...
 */
export type DropRecordHandler<T, M extends LedgerMeta = LedgerMeta> = (record: LedgerRecord<T, M>, authParams: JwtConfig) => Promise<DropRecordResponse>;
/**
 * A handler for reading records on the remote API.
 */
export type ReadRecordHandler<T, M extends LedgerMeta = LedgerMeta> = (authParams: JwtConfig) => Promise<LedgerRecord<T, M>>;
/**
...
export declare class DropRecordBuilder<T extends Record<string, any>, M extends LedgerMeta = LedgerMeta> extends BaseRecordBuilder<T, M> {
     ...
     */
    send(): Promise<DropRecordResponse>;
    /**
