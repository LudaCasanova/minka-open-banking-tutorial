...
import { ChangeMeta, JwtConfig, LedgerPagedList, LedgerRecord } from "../../../../types/src";
...
export declare class BaseChangeClient<TRecord> extends BaseClient {
     ...
     */
    read(id: number, authParams?: Partial<JwtConfig>): Promise<ChangeResponse<TRecord>>;
    /**
     ...
     */
    list(params?: LedgerListParams): Promise<ChangesResponse<TRecord>>;
}
