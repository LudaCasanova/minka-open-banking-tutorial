...
class EffectClient extends base_client_1.BaseClient {
    ...
    init(record) {
        const builder = new create_record_builder_1.CreateRecordBuilder(async (record, authParams) => {
            return this.createRecord(EFFECTS_PATH, EffectResponse, record, authParams);
        });
    ...
    edit(record) {
        const builder = new update_record_builder_1.UpdateRecordBuilder(async (record, authParams) => {
            return this.updateRecord(`${EFFECTS_PATH}/${encodeURIComponent(record.data.handle)}`, EffectResponse, record, authParams);
        });
        record = lodash_1.default.cloneDeep(record);
        return builder.init(record);
    }
    ...
    async read(id, authParams) {
        return this.getRecord(`${EFFECTS_PATH}/${encodeURIComponent(id)}`, EffectResponse, authParams);
    }
    /**
