...
import { JwtConfig, LedgerEffect, LedgerIdentifier, LedgerPagedList, LedgerRecord } from "../../../types/src";
...
export declare class EffectClient extends BaseClient {
     ...
     */
    init(record?: Partial<LedgerRecord<LedgerEffect>>): CreateRecordBuilder<LedgerEffect, EffectResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     ...
     * @returns a builder instance
     */
    edit(record: LedgerRecord<LedgerEffect>): UpdateRecordBuilder<LedgerEffect, EffectResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     * Initializes a builder instance for updating existing records.
     * The builder supports chaining to make it easier to work with
     ...
     * @returns a builder instance
     */
    from(record: LedgerRecord<LedgerEffect>): UpdateRecordBuilder<LedgerEffect, EffectResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     ...
     */
    read(id: LedgerIdentifier, authParams?: Partial<JwtConfig>): Promise<EffectResponse>;
    /**
