...
import { JwtConfig, LedgerIdentifier, LedgerPagedList, LedgerRecord, LedgerSigner } from "../../../types/src";
...
export declare class SignerClient extends BaseClient {
     ...
     * @returns a builder instance
     */
    edit(record: LedgerRecord<LedgerSigner>): UpdateRecordBuilder<LedgerSigner, SignerResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     * Initializes a builder instance for updating existing records.
     * The builder supports chaining to make it easier to work with
     ...
     * @returns a builder instance
     */
    from(record: LedgerRecord<LedgerSigner>): UpdateRecordBuilder<LedgerSigner, SignerResponse, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>;
    /**
     ...
     */
    read(id: LedgerIdentifier, authParams?: Partial<JwtConfig>): Promise<SignerResponse>;
    /**
