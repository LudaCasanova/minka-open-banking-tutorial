...
export declare class SignerRecordBuilder extends CreateRecordBuilder<LedgerSigner, SignerResponse> {
     ...
     * @returns the constructed record
     */
    read(readOptions?: SignerRecordReadOptions): Promise<import("../../../types/src").LedgerRecord<LedgerSigner, import("../../../types/src").LedgerMeta<import("../../../types/src").LedgerSignatureCustom>>>;
    /**
