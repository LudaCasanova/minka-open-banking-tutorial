...
import { IntentMeta, IntentRecord, JwtConfig, LedgerIdentifier, LedgerIntent, LedgerPagedList } from "../../../types/src";
...
export declare class IntentClient extends BaseClient {
     ...
     */
    read(id: LedgerIdentifier, authParams?: Partial<JwtConfig>): Promise<IntentResponse>;
    /**
