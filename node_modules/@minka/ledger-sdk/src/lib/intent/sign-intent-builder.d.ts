 ...
 */
import { IntentMeta, IntentRecord, IntentSignatureData, JwtConfig, LedgerIntent, LedgerSignature } from "../../../types/src";
import { BaseCompositeBuilder } from '../common/services/base-composite-builder';
import { IntentResponse } from './intent-client';
type SendSignatureFunction = (signature: LedgerSignature<IntentSignatureData>, authParams: Partial<JwtConfig>) => Promise<IntentResponse>;
/**
 ...
 *  .send()
 */
export declare class SignIntentBuilder extends BaseCompositeBuilder<LedgerIntent, IntentResponse, IntentMeta, IntentSignatureData> {
    /**
