...
class SchemaClient extends base_client_1.BaseClient {
    ...
    init(record) {
        const builder = new create_record_builder_1.CreateRecordBuilder(async (record, authParams) => {
            return this.createRecord(SCHEMAS_PATH, SchemaResponse, record, authParams);
        });
    ...
    edit(record) {
        const builder = new update_record_builder_1.UpdateRecordBuilder(async (record, authParams) => {
            return this.updateRecord(`${SCHEMAS_PATH}/${encodeURIComponent(record.data.handle)}`, SchemaResponse, record, authParams);
        });
        record = lodash_1.default.cloneDeep(record);
        return builder.init(record);
    }
    ...
    async read(id, authParams) {
        return this.getRecord(`${SCHEMAS_PATH}/${encodeURIComponent(id)}`, SchemaResponse, authParams);
    }
    /**
