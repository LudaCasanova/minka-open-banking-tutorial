...
import { JwtConfig, LedgerHandle, LedgerPagedList, LedgerRecord, LedgerRequest } from "../../../types/src";
...
export declare class RequestClient extends BaseClient {
     ...
     */
    read(handle: LedgerHandle, authParams?: Partial<JwtConfig>): Promise<RequestResponse>;
    /**
