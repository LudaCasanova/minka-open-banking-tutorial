...
exports.publicKeyEd25519RawToDer = exports.publicKeyEd25519DerToRaw = exports.privateKeyEd25519RawToDer = exports.privateKeyEd25519DerToRaw = exports.isValidPkcs5EncryptedKey = exports.assertPkcs5EncryptedKey = exports.parsePkcs5EncryptedKey = exports.ASN1_PKCS5_REGEX = exports.ASN1_PKCS5_VALUE_PREFIX = exports.ASN1_PKCS5_IV_PREFIX = exports.ASN1_PKCS5_ITERATIONS_PREFIX = exports.ASN1_PKCS5_SALT_PREFIX = exports.ASN1_PUBLIC_PREFIX = exports.ASN1_PRIVATE_PREFIX = void 0;
/**
 ...
 */
exports.ASN1_PRIVATE_PREFIX = '302e020100300506032b657004220420';
/**
 ...
 */
exports.ASN1_PUBLIC_PREFIX = '302a300506032b6570032100';
/**
 ...
 */
exports.ASN1_PKCS5_SALT_PREFIX = '30819b305706092a864886f70d01050d304a302906092a864886f70d01050c301c0408';
/**
 ...
 */
exports.ASN1_PKCS5_ITERATIONS_PREFIX = '0202';
/**
 ...
 * @see example https://lapo.it/asn1js/#MIGbMFcGCSqGSIb3DQEFDTBKMCkGCSqGSIb3DQEFDDAcBAhZEct9sFzlqQICCAAwDAYIKoZIhvcNAgkFADAdBglghkgBZQMEASoEELA0tLQ9x46HowOAowRFlHsEQI9KqZlY2pGgnywanIaPmH6ZuRDhxIJVP_w4y7_dV161UZnxjcKwPq070D3gZXcguucm1BeOVnq6P_e2kj75344
 */
exports.ASN1_PKCS5_IV_PREFIX = '300c06082a864886f70d02090500301d060960864801650304012a0410';
/**
 ...
 * @see example https://lapo.it/asn1js/#MIGbMFcGCSqGSIb3DQEFDTBKMCkGCSqGSIb3DQEFDDAcBAhZEct9sFzlqQICCAAwDAYIKoZIhvcNAgkFADAdBglghkgBZQMEASoEELA0tLQ9x46HowOAowRFlHsEQI9KqZlY2pGgnywanIaPmH6ZuRDhxIJVP_w4y7_dV161UZnxjcKwPq070D3gZXcguucm1BeOVnq6P_e2kj75344
 */
exports.ASN1_PKCS5_VALUE_PREFIX = '0440';
/**
 ...
 * @see example https://lapo.it/asn1js/#MIGbMFcGCSqGSIb3DQEFDTBKMCkGCSqGSIb3DQEFDDAcBAhZEct9sFzlqQICCAAwDAYIKoZIhvcNAgkFADAdBglghkgBZQMEASoEELA0tLQ9x46HowOAowRFlHsEQI9KqZlY2pGgnywanIaPmH6ZuRDhxIJVP_w4y7_dV161UZnxjcKwPq070D3gZXcguucm1BeOVnq6P_e2kj75344
 */
exports.ASN1_PKCS5_REGEX = new RegExp(`^${exports.ASN1_PKCS5_SALT_PREFIX}(?<salt>[0-9a-f]{16})${exports.ASN1_PKCS5_ITERATIONS_PREFIX}((?<iterations>[0-9a-f]{4}))${exports.ASN1_PKCS5_IV_PREFIX}(?<iv>[0-9a-f]{32})${exports.ASN1_PKCS5_VALUE_PREFIX}(?<value>[0-9a-f]{128})$`);
/**
 ...
 */
function parsePkcs5EncryptedKey(pkcs5PayloadHex) {
    const match = exports.ASN1_PKCS5_REGEX.exec(pkcs5PayloadHex);
    if (!match) {
        throw new Error('Invalid pkcs5 encrypted key format');
    }
    return match.groups;
}
exports.parsePkcs5EncryptedKey = parsePkcs5EncryptedKey;
/**
 ...
 * @see sections 5.2 and 6.2 in https://www.rfc-editor.org/rfc/rfc2898
 */
function assertPkcs5EncryptedKey(pkcs5PayloadHex) {
    if (!isValidPkcs5EncryptedKey(pkcs5PayloadHex)) {
        throw new Error('Invalid pkcs5 encrypted key format');
    }
}
exports.assertPkcs5EncryptedKey = assertPkcs5EncryptedKey;
/**
 ...
 * @see sections 5.2 and 6.2 in https://www.rfc-editor.org/rfc/rfc2898
 */
function isValidPkcs5EncryptedKey(pkcs5PayloadHex) {
    return exports.ASN1_PKCS5_REGEX.test(pkcs5PayloadHex);
}
exports.isValidPkcs5EncryptedKey = isValidPkcs5EncryptedKey;
/**
 ...
 */
function privateKeyEd25519DerToRaw(keyHex) {
    if (keyHex.length != 96) {
        throw new Error(`Unexpected der private key length in hex ${keyHex.length}, expected 96`);
    }
    if (!keyHex.startsWith(exports.ASN1_PRIVATE_PREFIX)) {
        throw new Error('Unexpected private key prefix');
    }
    // Remove the ASN.1 prefix
    return keyHex.slice(exports.ASN1_PRIVATE_PREFIX.length);
}
exports.privateKeyEd25519DerToRaw = privateKeyEd25519DerToRaw;
/**
 ...
 * @throws if input key has wrong length
 */
function privateKeyEd25519RawToDer(keyHex) {
    if (keyHex.length != 64) {
        throw new Error(`Unexpected raw private key length in hex ${keyHex.length}, expected 64`);
    }
    // Prepend the ASN.1 prefix to raw key data
    return `${exports.ASN1_PRIVATE_PREFIX}${keyHex}`;
}
exports.privateKeyEd25519RawToDer = privateKeyEd25519RawToDer;
/**
 ...
 * @throws if input key has wrong length
 */
function publicKeyEd25519DerToRaw(keyHex) {
    if (keyHex.length != 88) {
        throw new Error(`Unexpected der public key length in hex ${keyHex.length}, expected 88`);
    }
    if (!keyHex.startsWith(exports.ASN1_PUBLIC_PREFIX)) {
        throw new Error('Unexpected public key prefix');
    }
    // Remove the ASN.1 prefix
    return keyHex.slice(exports.ASN1_PUBLIC_PREFIX.length);
}
exports.publicKeyEd25519DerToRaw = publicKeyEd25519DerToRaw;
/**
 ...
 * @throws if input key has wrong length
 */
function publicKeyEd25519RawToDer(keyHex) {
    if (keyHex.length != 64) {
        throw new Error(`Unexpected raw public key length in hex ${keyHex.length}, expected 64`);
    }
    // Prepend the ASN.1 prefix to raw key data
    return `${exports.ASN1_PUBLIC_PREFIX}${keyHex}`;
}
exports.publicKeyEd25519RawToDer = publicKeyEd25519RawToDer;
